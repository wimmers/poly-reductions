...
of functions
\<close>
theory "Alternative_IMP-_Reductions"
  imports Alternative_Abstractions Alternative_Bounds 
begin
...
proof (auto simp add: is_reduction_def decides_def)
  ...
  have "comp' (f;;g) x z" using comp_comp f_part(1)_g_part(1) comp'_def by auto
